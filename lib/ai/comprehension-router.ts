...
3. "teach": true ONLY if this is a genuine teaching moment — the user is practicing a word/phrase, asking what something means or how to say it, asking for a word, or clearly wants to learn something specific right now. Otherwise false. Just chatting, venting, telling a story, or saying their name is NOT a teaching moment.
