...
export const ROOM_WARN_SECONDS = 480;  // wrap-up (in voice) at 8:00 — the Gemini Live TIME ARC paces the stages itself (proven 9-minute full run); two minutes is the natural close
