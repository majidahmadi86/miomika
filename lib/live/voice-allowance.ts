...
export const ROOM_WARN_SECONDS = 540;  // wrap-up + exit stage at 9:00 — the SYSTEM METRONOME already forces assessment at 7:30, so the close needs only its final minute (goodbye grace covers the tail)
