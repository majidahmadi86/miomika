...
export const ROOM_WARN_SECONDS = 420;  // wrap-up (in voice) at 7 min — the turn engine needs a 3-min runway to land the assessment + exit ticket + goodbye before the 10-min stop
