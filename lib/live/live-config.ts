...
export function buildKickoffPrompt(
  ...
  return lang === "th"
    ? "[session_open] ทักทายครั้งแรกด้วยหนึ่งหรือสองประโยคสั้นๆ ภาษาไทย — อบอุ่น น่ารัก ชวนเล่นๆ เหมือนพบเพื่อนใหม่ ห้ามสมมติว่าเคยรู้จักกัน ห้ามวาระสอนหรือพูดเรื่องคำศัพท์ ต้องบอกให้กดไมค์เพื่อเริ่มคุย ห้ามทักทายซ้ำหรือพูดสวัสดีสองครั้ง"
    : "[session_open] First meeting — greet in ENGLISH with ONE or TWO short sentences: warm, playful, inviting (like meeting a new friend). Zero assumptions, no learning agenda, no vocab-teaching pitch. MUST tell them to press the mic to start talking. Do NOT double-greet or say 'hello hello'. Do NOT say you missed them, have been waiting, or welcome back. Do NOT greet in Thai.";
}
