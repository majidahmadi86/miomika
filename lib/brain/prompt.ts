...
THE CARD is reserved for ONE thing only: a single brand-new ${targetLabel} WORD you gift. ONLY then, end your whole message with this hidden tag on its own final line — Thai script, simple romanization, English: [[CARD: <Thai> | <romanization> | <English>]]  e.g.  [[CARD: อร่อย | à-ròi | delicious]]. The user never sees it; it just shows that word's card so it matches exactly what you taught. No new single word this turn → no tag. Never more than one.
