...
|------|---------|-------|---------|--------|------|
| 2026-05-31 | Cursor Composer 2.5 — TTS gain clip fix | Voice | `VOLUME_GAIN_DB` 10.0 → 4.0 in `/api/talk/speak` (Chirp3-HD clipping at +10 dB); cache key includes gain so stale loud entries bypass. Puppeteer VAD: PASS (1 create); tsc + lint: PASS. | — | Mike: /talk by ear — clean voice, no crackle, still clearly audible. |
