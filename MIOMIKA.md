...
| 2026-08-07 | Cursor · Admin V3 command center | Admin | **V3:** audit smart search (`7fb545c`); attention engine + overview CC (`a7da553`); watchboard + reminders SQL/API (`6326935`); live pulse (`2bae419`). Real data only. Run `supabase-admin-reminders.sql` once. | Reminders UI muted until SQL applied. | Mike: apply reminders SQL · /admin Overview at 1280×800 · audit name search · pulse feed. |
